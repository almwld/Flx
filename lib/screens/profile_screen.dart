                        ...
                        children: [
                          Container(
                            ...
                            child: _userData!['avatar_url'] != null
                                ? ClipOval(child: Image.network(_userData!['avatar_url'], fit: BoxFit.cover))
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    _buildStatItem(_userData!['rating']?.toStringAsFixed(1) ?? '0.0', 'التقييم'),
                                    const SizedBox(width: 16),
                                    _buildStatItem(_userData!['followers']?.toString() ?? '0', 'المتابعون'),
                                    const SizedBox(width: 16),
