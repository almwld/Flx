...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Future<void> _loadRatings() async {
    _ratings = await SupabaseService.getProductRatings(widget.product.id);
    _avgRating = await SupabaseService.getProductAverageRating(widget.product.id);
    setState(() {});
  }
          ...
          child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: p.inStock ? Colors.green : Colors.red, fontWeight: FontWeight.bold),
                  ),
                ]),
              ),
              const SizedBox(height: 16),
              ...
              _ratings.isEmpty
                  ...
                  : Column(children: _ratings.take(3).map((r) => ListTile(
                      leading: CircleAvatar(child: Text(r.userName[0])),
                      title: Text(r.userName),
                      subtitle: Row(children: List.generate(5, (i) => Icon(Icons.star, size: 14, color: i < r.rating ? Colors.amber : Colors.grey))),
                      trailing: Text(r.formattedDate),
                    )).toList()),
              const SizedBox(height: 24),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, i) => GestureDetector(
                      onTap: () => Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (_) => ProductDetailScreen(product: _related[i])),
                      ),
                      child: Container(
                        width: 100,
                        ...
                        child: Column(children: [
                          Expanded(
                            child: ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: _related[i].images.isNotEmpty ? _related[i].images.first : '',
                                fit: BoxFit.cover,
                          ...
                          Padding(
                            ...
                            child: Text(_related[i].title, style: const TextStyle(fontSize: 10), maxLines: 1, overflow: TextOverflow.ellipsis),
                          ),
                        ]),
                      ),
                    ),
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => CheckoutScreen(items: [CheckoutItem(product: p.toJson(), quantity: _quantity)]),
                          ),
                        );
                      },
                    ),
