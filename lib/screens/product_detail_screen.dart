            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder(
                    future: Future.wait([
                      SupabaseService.getProductRatings(p.id),
                      SupabaseService.getProductAverageRating(p.id),
                    ]),
                    builder: (ctx, snapshot) {
                      ...
                      final ratings = snapshot.data![0] as List<RatingModel>;
                      final avg = snapshot.data![1] as double;
                      return Column(
                        children: [
                          Row(
                            children: [
                                ...
                                children: [
                                  Row(
                                    children: List.generate(5, (i) {
                                      return Icon(
                                        i < avg.floor() ? Icons.star : 
                                        (i < avg ? Icons.star_half : Icons.star_border),
                                        color: Colors.amber,
                                        size: 16,
                                      );
                                    }),
                          ...
                          ...ratings.take(3).map((r) => _buildRatingPreview(r)),
                        ],
                      );
                    },
                  ),
