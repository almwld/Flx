                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(card[.flag.] as String as String, style: const TextStyle(fontSize: 30)),
                              const Spacer(),
                              Container(
                                ...
                                child: Text(
                                  card[.currency.] as String as String,
                          ...
                          const Spacer(),
                          Text(card[.name.] as String as String, style: const TextStyle(color: Colors.white70)),
